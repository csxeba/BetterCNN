...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/bettercnn.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/bettercnn.exe: ${OBJECTFILES}
...
${OBJECTDIR}/Tensor/HVolume.o: Tensor/HVolume.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Tensor/HVolume.o Tensor/HVolume.cpp

${OBJECTDIR}/Tensor/Matrix.o: Tensor/Matrix.cpp 
	${MKDIR} -p ${OBJECTDIR}/Tensor
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Tensor/Matrix.o Tensor/Matrix.cpp

${OBJECTDIR}/Tensor/Vector.o: Tensor/Vector.cpp 
	${MKDIR} -p ${OBJECTDIR}/Tensor
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Tensor/Vector.o Tensor/Vector.cpp

${OBJECTDIR}/Tensor/Volume.o: Tensor/Volume.cpp 
	${MKDIR} -p ${OBJECTDIR}/Tensor
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Tensor/Volume.o Tensor/Volume.cpp
...
${OBJECTDIR}/utility/operations.o: utility/operations.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/utility/operations.o utility/operations.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/bettercnn.exe
